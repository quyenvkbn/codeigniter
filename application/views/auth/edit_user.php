    ...
    <?php echo form_open(uri_string(),array('class' => 'form-horizontal'));?>
          ...
          <?php if ($this->ion_auth->is_admin()): ?>
              ...
              <?php foreach ($groups as $group):?>
                  ...
                  ?>
                  <input type="checkbox" <?php echo ($group['name'] == 'admin') ? 'disabled' : '' ?>  name="groups[]" value="<?php echo $group['id'];?>"<?php echo $checked;?>>
          ...
          <p><?php echo form_submit('submit', lang('edit_user_submit_btn'),array('style' => 'color:white'));?></p>
